...
# Função para extrair telefones da página
def get_phones_from_page(driver):
    phones = []
...
def extract_data_from_search(query):
    ...
    for company_url in links:
        ...
        # Extrair o nome da empresa, telefones e e-mails
        phones = get_phones_from_page(driver)
        emails = get_emails_from_page(driver)

        # Extrair o nome da empresa da página
...
def get_company_name(driver):
    ...
    # Buscar o nome da empresa no título ou meta tags
