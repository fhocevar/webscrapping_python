...
def consulta_empresas(empresa_list):
    ...
    for nome_empresa in empresa_list:
        # Mudança para Belém, PA
        url = f'https://maps.googleapis.com/maps/api/place/textsearch/json?query={nome_empresa}+Belém+PA&key={api_key}'
    ...
    with open('empresas_Belem.csv', mode='w', newline='', encoding='utf-8') as file:
