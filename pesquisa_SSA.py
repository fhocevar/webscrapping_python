...
def consulta_empresas(empresa_list):
    ...
    for nome_empresa in empresa_list:
        url = f'https://maps.googleapis.com/maps/api/place/textsearch/json?query={nome_empresa}+Salvador+BA&key={api_key}'
    ...
    with open('empresas_Salvador.csv', mode='w', newline='', encoding='utf-8') as file:
