...
#contaespaco api AIzaSyAhquA5axfQwu49jyqym5Rd4tUin-cCZkc  

def consulta_empresas(empresa_list, cidades_list):
    api_key = 'AIzaSyA4AydZb5fovZ6_gaUvZcaFMMfPNNbuLKc'  # Insira sua chave de API do Google válida aqui
    ...
    # Salva o arquivo
    arquivo_nome = 'empresas_multi_fer_suco_oleoespaco.xls'
...
empresas = ["suco de uva", "suco de mexirica", "vinagre de mel", "vinagre", "fertilizante", "oleo", "oleo de pecan", "oleo de macadamia"]
