...
def consulta_empresas(empresa_list):
    ...
    for nome_empresa in empresa_list:
        # Mudança para Belo Horizonte, MG
        url = f'https://maps.googleapis.com/maps/api/place/textsearch/json?query={nome_empresa}+Belo+Horizonte+MG&key={api_key}'
    ...
    with open('empresas_Belo_Horizonte.csv', mode='w', newline='', encoding='utf-8') as file:
